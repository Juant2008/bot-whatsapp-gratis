...
const server = http.createServer(async (req, res) => {
    ...
    if (parsedUrl.pathname === '/cobrar-ahora') {
        ...
        const filtros = {
            ...
            dias: parsedUrl.query.dias || 30 // BAJAMOS EL DEFAULT A 30 PARA QUE VEAS DATOS
        };
        ...
        <style>
            ...
            .client-name { font-weight: bold; font-size: 14px; text-transform: uppercase; color: #1c1c1e; }
