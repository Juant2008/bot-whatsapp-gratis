...
// --- CEREBRO DE LA IA RESTAURADO (9 OPCIONES) ---
const knowledgeBase = `
Eres el asistente virtual de ONE4CARS. Atiende de forma amable y precisa.
IMPORTANTE: Si el cliente pregunta por estos temas, responde con estos enlaces exactos:
...
REGLAS: Responde saludos. No inventes links. Si el tema no está aquí, indica que un asesor le contactará.
`;
...
// --- SERVIDOR HTTP: PANEL DE COBRANZA Y QR ---
        ...
        req.on('end', async () => {
            try {
                ...
                if (socketBot && data.facturas) {
                    ...
                    res.writeHead(400); res.end('Bot no listo');
                }
            ...
            res.write(`
                ...
                <body class="d-flex align-items-center justify-content-center vh-100 bg-light">
                    <div class="text-center p-4 shadow-sm bg-white rounded w-75">
                        <h2 class="h4 mb-4">🚗 ONE4CARS Bot</h2>
                        <span class="badge bg-success mb-3">${qrCodeData}</span>
                        <a href="/cobranza" class="btn btn-primary btn-lg w-100 d-block mb-2">PANEL COBRANZA</a>
                    </div>
                </body>
                </html>
            `);
